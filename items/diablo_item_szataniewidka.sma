...
#define PLUGIN	"Invisibility Coat"
...
public plugin_init()
{
	...
	diablo_register_item( "Plaszcz Niewidzialnosci" , 250 );
}

public plugin_natives()
{
	register_native("diablo_get_user_render_coat","getUserRender");
}
...
public diablo_item_set_data( id ){
	iNiewidka[ id ]	=	random_num(110,150);
	bHas[ id ] = true;
	new szClass[ 64 ];
	diablo_get_class_name( diablo_get_user_class( id ) , szClass , charsmax( szClass ) ) ;
	if( !equal( szClass , "Ninja" ) )
